...
ASTERISK_ACCOUNTS=${ASTERISK_CONTAINER}
...
while [[ $n -lt $END ]]; do {
  ...
  python3 sip-caller.py -f $AUDIO1 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6002@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO2 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6003@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO1 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6004@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO2 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6005@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO1 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6002@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO2 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6003@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO1 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6004@${ASTERISK_ACCOUNTS} &
  python3 sip-caller.py -f $AUDIO2 -t sip:${EXT}@${ASTERISK_CONTAINER} -c 6005@${ASTERISK_ACCOUNTS} && sleep 2
